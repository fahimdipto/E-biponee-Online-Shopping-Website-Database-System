            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				  ...
				  <td>
				  <a href="editadmin.php?admin=<?php echo $data["name"] ?>"><button type="button" class="btn btn-success">Edit</button></a>
				  <a href="delete_admin.php?admin=<?php echo $data["name"] ?>"><button type="button" class="btn btn-danger">Delete</button></a>
				  </td>
                </tr>
				<?php
						}
