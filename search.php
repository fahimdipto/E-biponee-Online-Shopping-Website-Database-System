...
<main>
	<section class="container">
		...
		<h1 class="main-ttl"><span>Search Result</span></h1>
		...
		<div class="section-cont">
			...
			<div class="prod-items section-items">
                ...
                $sql = "SELECT * FROM product where product_name LIKE '%{$keyword}%' OR product_price LIKE '%{$keyword}%' OR product_description LIKE '%{$keyword}%'";
                ...
                if ($result->num_rows > 0){
                    while($row = $result->fetch_assoc()) {
						...
						?>
						<a class="prodlist-i-img" href=""><img src="<?php echo "../ecommerce/admin/uploads/".$img ?>" alt="" /></a>
						<?php
					...
					?>
						<span class="label label-primary" style="    font-size: 28px;
    margin-left: 18%;">No search Result Found Please try again</span>
					<?php
				}
				}
                ?>
